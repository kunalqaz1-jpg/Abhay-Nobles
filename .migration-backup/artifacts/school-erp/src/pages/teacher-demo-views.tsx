...
} from "@/shared/attendance-store";
import {
  getStudents,
  saveStudent,
  type StudentDirectoryRecord,
} from "@/shared/directory-store";
import { saveHomework } from "@/shared/homework-store";
import {
  getEvents,
  getMaterials,
  getMessages,
...
} from "@/shared/live-content-store";
import { saveResultRecord, type ExamType } from "@/shared/result-store";
